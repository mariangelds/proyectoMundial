...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { empatados: @statistic.empatados, ganados: @statistic.ganados, goles: @statistic.goles, juegos: @statistic.juegos, perdidos: @statistic.perdidos, puntaje: @statistic.puntaje }
    end
  ...
  test "should update statistic" do
    patch :update, id: @statistic, statistic: { empatados: @statistic.empatados, ganados: @statistic.ganados, goles: @statistic.goles, juegos: @statistic.juegos, perdidos: @statistic.perdidos, puntaje: @statistic.puntaje }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
